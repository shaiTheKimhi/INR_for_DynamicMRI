...
log_path = './log_cmr_temporal/spoke{}_{}'.format(spoke_num, str(datetime.datetime.now().strftime('%y%m%d_%H%M%S')))
...
for patient_idx in range(len(cds)):
    ...
    for z_index in range(nz):
        ...
        del inr, pos, pos_dense_t, kdata, nufft_op, smap, img_gt, img_gt_full, img_full, ktraj, ktraj_full
        if best_intensity is not None:
            del best_intensity
